...
import sys
import itertools
from preproc import pointers
from preproc.pointers import file_open, file_close, load_pointers

"""
resume preprocessing from the last processed id per batch
"""
...
if __name__=="__main__":
    ...
    outfile = '{}.{}.{}_{}.add'.format(infile , lang, 'tokenized', batch)
